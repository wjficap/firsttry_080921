...
function encrypt() {
  ...
  var encrypted =  sjcl.encrypt(document.getElementById("id_password").value, document.getElementById("id_text_input").value);
   
  document.getElementById("id_result").innerText = encrypted;
  
}
 
function decrypt() {
  
  var decrypted =  sjcl.decrypt(document.getElementById("id_password").value, document.getElementById("id_cipher_input").value);
   
  document.getElementById("id_result").innerText = decrypted;
  
}

function copy_all() {
  var copyText = document.getElementById('id_result').innerText;
